from sqlalchemy import Column, Integer, String, DateTime, ForeignKey, Boolean, Table, DECIMAL  # DECIMAL pour la définition de la colonne
from sqlalchemy.orm import relationship
from datetime import datetime
from config.db import Base
import bcrypt

# Table d'association pour les permissions (table intermédiaire)
...
class Employee(Base):
    ...
    def set_password(self, password):
        ...
        # Stocke le hash dans la base de données
